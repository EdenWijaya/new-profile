...
const Navbar = () => {
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xk:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
            <a href="#top">
                <Image src={assets.logo} alt='' className='w-20 cursor-pointer mr-14'/>
            </a>
            ...
            {/* mobile menu */}
            <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 bg-rose-50 transition duration-1000'>
                ...
                <li>
                    <a className='font-Ovo' onClick={closeMenu} href="#contact">Contact</a>
                </li>
            </ul>
        </nav>
    </>
